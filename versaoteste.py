...
timer_rodando = False
modo_foco = True
tempo_restante = 10  # VERSÃO DE TESTE: Ajustado para 10 segundos
id_timer = None
...
def resetar_timer():
    ...
    ttl.configure(text="TIME FLOW")  # Ajustado para o nome novo
    camadacnt.configure(border_color="#00BFFF")
    timer.configure(text="25:00")
    botão1.configure(
        text="Start ▶",
...
timer = CTkLabel(
    camadacnt,
    text="00:10",  # Mostra o tempo inicial de 10 segundos do teste na tela
    font=("arial", 60,"bold"),
    text_color="#F9FAFB",
)
